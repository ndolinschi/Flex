...
use agentloop_contracts::{
    ...
    TurnStopReason, TurnSummary, VerdictOutcome, VerificationVerdict, reduce,
};
use agentloop_core::{
    Agent, BackgroundEntrySummary, BackgroundProcessRegistry, DemoteRegistry, EventStream, Hook,
    PluginRegistry, PluginRole, PluginRoleTools, ProviderRegistry, SessionStore, StoredEvent,
