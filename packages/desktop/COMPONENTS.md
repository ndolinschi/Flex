...
| `WindowTitleBar` | Compact custom window chrome (`decorations: false`, 30px): traffic lights / caption buttons + File/Edit/View/Help + drag region (double-click zooms — fullscreen on macOS, maximize elsewhere); macOS corners clipped natively to 10px | `onOpenCommandPalette?`, `onOpenSearch?` | App shell |
