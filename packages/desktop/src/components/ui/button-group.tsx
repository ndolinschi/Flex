...
function ButtonGroupText({
  ...
  return (
    <Comp
      className={cn(
        "flex items-center gap-2 rounded-md border border-stroke-3 bg-fill-3 px-2.5 text-sm font-medium text-ink [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
...
function ButtonGroupSeparator({
  ...
  return (
    <Separator
      ...
      className={cn(
        "relative self-stretch bg-stroke-3 data-horizontal:mx-px data-horizontal:w-auto data-vertical:my-px data-vertical:h-auto",
        className
      )}
      {...props}
    />
