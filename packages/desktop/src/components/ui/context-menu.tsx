...
function ContextMenuItem({
  ...
  return (
    <ContextMenuPrimitive.Item
      ...
      className={cn(
        "group/context-menu-item relative flex w-full cursor-default items-center justify-start gap-1.5 rounded-md px-1.5 py-1 text-left text-sm outline-hidden select-none data-inset:pl-7",
        itemHighlight,
        itemHighlightDescendants,
...
function ContextMenuSubTrigger({
  ...
  return (
    <ContextMenuPrimitive.SubmenuTrigger
      ...
      data-inset={inset}
      className={cn(
        "flex w-full cursor-default items-center justify-start gap-1.5 rounded-md px-1.5 py-1 text-left text-sm outline-hidden select-none data-inset:pl-7",
        itemHighlight,
        itemHighlightDescendants,
        "data-popup-open:bg-fill-4 data-popup-open:text-ink data-open:bg-fill-4 data-open:text-ink",
        "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
...
function ContextMenuSubContent({
  ...
  return (
    <ContextMenuContent
      ...
      className="w-auto min-w-[96px] rounded-md bg-panel p-1 text-ink shadow-popover"
      side="right"
      {...props}
    />
  )
