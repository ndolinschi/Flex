  ...
  switch (row.type) {
    case "user": {
      ...
      return (
        <Message
          align="end"
          className="group/row ml-auto w-fit max-w-full min-w-[150px] gap-0 text-base"
        >
          <MessageContent className="w-fit max-w-full gap-0">
            <Bubble
              align="end"
              variant="outline"
              className={cn(
    ...
    case "assistant": {
      ...
      return (
        <Message align="start" className="group/row min-h-5 gap-0 text-base">
