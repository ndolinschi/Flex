...
export const BrowserToolbar = ({
  ...
  return (
    <div
      ref={toolbarRef}
      className="relative z-20 flex h-[var(--header-height)] min-h-[var(--header-height)] shrink-0 items-center gap-1 overflow-hidden bg-bg px-2"
      ...
      <div className="relative min-w-0 flex-1">
        {editing ? (
          <input
            ...
            className="w-full rounded-sm bg-fill-4 px-2 py-1 text-sm text-ink outline-none focus-visible:[box-shadow:0_0_0_1px_var(--color-stroke-2)]"
          />
        ) : (
          <button
            type="button"
