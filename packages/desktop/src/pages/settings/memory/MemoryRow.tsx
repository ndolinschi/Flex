...
export const MemoryRow = ({
  ...
  return (
    <Card className="rounded-md bg-panel p-0">
              ...
              <>
                <Tooltip label="Expiry">
                  <Button
                    ...
                    className="text-ink-secondary hover:bg-fill-4 hover:text-ink"
                  >
                ...
                <Tooltip label="Delete">
                  <Button
                    ...
                    className="text-ink-secondary hover:bg-fill-4 hover:text-ink hover:text-destructive"
                  >
